...
RegisterNetEvent('qbx_admin:server:playerOptionsGeneral', function(selected, selectedPlayer, input)
    if not exports.qbx_core:HasPermission(source, config.eventPerms.playerOptionsGeneral) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
...
local administrationOptions = {
    function(source, selectedPlayer, input)
        if not exports.qbx_core:HasPermission(source, config.eventPerms.kick) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
        DropPlayer(selectedPlayer.id, input)
    end,
    function(source, selectedPlayer, input)
        if not exports.qbx_core:HasPermission(source, config.eventPerms.ban) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
    ...
    function(source, selectedPlayer, input)
        if not exports.qbx_core:HasPermission(source, config.eventPerms.changePerms) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
...
RegisterNetEvent('qbx_admin:server:changePlayerData', function(selected, selectedPlayer, input)
    ...
    if not exports.qbx_core:HasPermission(source, config.eventPerms.changePlayerData) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
...
RegisterNetEvent('qbx_admin:server:giveAllWeapons', function(weaponType, playerID)
    ...
    if not exports.qbx_core:HasPermission(source, config.eventPerms.giveAllWeapons) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
...
lib.callback.register('qbx_admin:callback:getradiolist', function(source, frequency)
    ...
    if not exports.qbx_core:HasPermission(source, config.eventPerms.getRadioList) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
...
lib.callback.register('qbx_admin:server:getPlayers', function(source)
    if not exports.qbx_core:HasPermission(source, config.eventPerms.useMenu) then exports.qbx_core:Notify(source, Lang:t('error.no_perms'), 'error') return end
